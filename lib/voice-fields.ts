...
export const VOICE_FIELD_GROUPS = {
  ...
  admission: {
    ...
    description: 'Admission date, entering standard, previous school, district, and taluka.',
    example: 'Admitted tenth June two thousand twenty two in standard one, from Sunrise Primary School in Vadodara district and Vadodara taluka.',
    fields: [
      'admission_date',
      'admission_standard',
      'previous_school',
...
export const VOICE_FIELD_LABELS: Record<keyof ParsedGRFields, string> = {
  ...
  previous_school_district: 'Previous-school district',
  previous_school_subdistrict: 'Previous-school taluka',
